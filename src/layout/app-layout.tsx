...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'truck-driver'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Bookings', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Routes', path: '/routes', entity: 'route', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Transactions',
      path: '/transactions',
      entity: 'transaction',
    ...
    { name: 'Trucks', path: '/trucks', entity: 'truck', service: AccessServiceEnum.PROJECT, icon: FiBox },
