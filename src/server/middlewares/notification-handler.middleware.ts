...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'truck.update': {
    ...
    key: 'truck-details-updated',
    tenantPath: ['platform', 'truck'],
    userPath: [],
  },
  'route.create': {
    roles: ['business-owner'],
    key: 'new-route-created',
    tenantPath: ['platform', 'truck', 'route'],
    userPath: [],
  },
  'booking.update': {
    roles: ['business-owner', 'truck-driver'],
    key: 'booking-updated',
    tenantPath: ['platform', 'truck', 'booking'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'truck-driver'];
